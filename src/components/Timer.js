            ...
            {(new Date(countDownDate).getTime() >= new Date().getTime()) ?
                (
                    <Box display='flex' justifyContent='space-between' textAlign='center' my={1} >
                        ...
                        <Box sx={{ width: '45px' }}>
                            <Typography variant='h4'>{timerHours}</Typography>
                            <Typography fontSize={12}>Hours</Typography>
                        </Box>
                        <Typography variant='h4'>:</Typography>
                        <Box sx={{ width: '45px' }}>
                            <Typography variant='h4'>{timerMinutes}</Typography>
                            <Typography fontSize={12}>Minutes</Typography>
                        </Box>
                        <Typography variant='h4'>:</Typography>
                        <Box sx={{ width: '45px' }}>
                            <Typography variant='h4'>{timerSeconds}</Typography>
                            <Typography fontSize={12}>Seconds</Typography>
                        </Box>
                    </Box>
                ) :
                <Typography my={2} variant='h5'>Challenge Ended</Typography>
            }
        </>
    );
}
